...
const data: Project[] = [
    {
      id: "1",
      title: "IAM Central Frontend",
      repo: "https://github.com/iam-central/frontend",
      status: "Active",
      team: "UI Guild",
      tech: "Next.js",
    ...
    {
      id: "2",
      title: "IAM Authentication Module",
      repo: "https://github.com/iam-central/auth",
      status: "In Progress",
      team: "Component Devs",
      tech: "React",
    ...
    },
    {
      ...
      repo: "https://github.com/iam-central/users",
      status: "Active",
      team: "IAM Core",
      tech: "Spring Boot",
    ...
    },
    {
      ...
      repo: "https://github.com/iam-central/docs",
      status: "Active",
      team: "Tech Writers",
      ...
      contributors: [
        {
          ...
          avatar: "https://images.unsplash.com/photo-1744449641614-e0a4c11678a8?w=32&h=32&fit=crop&crop=face",
          role: "Documentation",
        },
        {
          name: "Vinay K",
    ...
    },
    {
      ...
      repo: "https://github.com/iam-central/analytics",
      status: "Active",
      team: "Data Squad",
      tech: "Python",
    ...
    {
      id: "6",
      title: "Real-time Session Monitor",
      repo: "https://github.com/iam-central/sessions",
      status: "Active",
      team: "Infrastructure",
      tech: "Socket.io",
    ...
    },
    {
      id: "7",
      title: "Theme Builder",
      repo: "https://github.com/iam-central/themes",
      status: "Active",
      team: "Design Systems",
      tech: "Tailwind CSS",
    ...
    },
    {
      id: "8",
      title: "Admin Console",
      repo: "https://github.com/iam-central/admin",
      status: "Active",
      team: "Dashboard Core",
      tech: "Remix",
    ...
    },
    {
      id: "9",
      title: "API Gateway",
      repo: "https://github.com/iam-central/gateway",
      status: "Active",
      team: "Platform",
      tech: "Node.js",
    ...
    {
      id: "10",
      title: "Multi-tenant Package",
      repo: "https://github.com/iam-central/multi-tenant",
      status: "Active",
      team: "Component Devs",
      tech: "TypeScript",
                        ...
                        {project.contributors.map((contributor, idx) => (
                          <Tooltip key={idx}>
                            <TooltipTrigger asChild>
                              <Avatar className="h-8 w-8 ring-2 ring-white hover:z-10 transition-all hover:scale-110 cursor-pointer">
