...
const AGENTS = [
  {
    ...
    title: "Solutions IA pour les entreprises",
    desc: "Agents IA autonomes, assistants virtuels intelligents, chatbots conversationnels et automatisation assistée par IA. Nous concevons des solutions adaptées aux réalités économiques et culturelles africaines.",
    stats: [{ v: "500+", l: "organisations" }, { v: "5+", l: "secteurs couverts" }],
  ...
  },
  {
    ...
    title: "Workflows intelligents & intégration",
    desc: "Automatisation des tâches répétitives, workflows intelligents, intégration de systèmes et optimisation opérationnelle. Libérez vos équipes pour des missions à plus forte valeur ajoutée.",
    stats: [{ v: "80%", l: "gain de temps" }, { v: "24/7", l: "opérations" }],
  ...
  },
  {
    ...
    title: "Applications Web, Mobile & SaaS",
    desc: "Conception et développement d'applications web, mobiles, plateformes SaaS et API. Des solutions numériques robustes, modulaires et évolutives pour accompagner votre croissance.",
    stats: [{ v: "100%", l: "made in Africa" }, { v: "3x", l: "plus rapide" }],
  ...
  },
  {
    ...
    title: "Former les talents africains au numérique",
    desc: "Programmes de formation à l'IA, aux métiers du numérique, coaching technologique et accompagnement des organisations. Nous développons la prochaine génération d'experts africains.",
    stats: [{ v: "1000+", l: "apprenants visés" }, { v: "5-15", l: "ans d'horizon" }],
  ...
  },
  {
    ...
    title: "Audit, stratégie & innovation numérique",
    desc: "Audit numérique, élaboration de stratégie digitale, modernisation des processus et accompagnement à l'innovation technologique. Nous guidons votre organisation vers l'excellence numérique.",
    stats: [{ v: "360°", l: "approche globale" }, { v: "ROI", l: "mesurable" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/researcher-CvhqOuV6irGwBOnJoTGFlXdbyYBRjb.png",
  },
]
