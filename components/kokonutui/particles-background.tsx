...
export default function ParticlesBackground({
  ...
  return (
    <div className={cn("relative overflow-hidden", "bg-white dark:bg-black", className)}>
      ...
      <motion.img
        src="images/logo-civitas-black-3D-RMBG.png"
        alt="Civitas Logo"
        className="absolute w-1/2 opacity-20 pointer-events-none"
        initial={{ top: "20%", left: "20%" }}
        animate={{
          top: ["10%", "65%", "15%", "55%", "5%", "45%", "10%"],
          left: ["10%", "60%", "55%", "10%", "65%", "5%", "10%"],
          rotate: [0, 15, -10, 8, -5, 5, 0],
        }}
        transition={{
          duration: 40,
